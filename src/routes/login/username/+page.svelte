<script lang="ts">
	...
	import { FIREBASE_DB, user, userData } from '$lib/firebase';
	...
	function checkAvailability() {
		...
		debounceTimer = setTimeout(async () => {
			...
			const ref = doc(FIREBASE_DB, 'usernames', username);
	...
	async function confirmUsername() {
		...
		batch.set(doc(FIREBASE_DB, 'usernames', username), { uid: $user?.uid });
		batch.set(doc(FIREBASE_DB, 'users', $user!.uid), {
			username,
